...
import argparse
import os
from postprocess_util import parse_SJS_output
...
if __name__ == "__main__":
    ...
    for prompt_id in model_output:
        parsed_output = parse_SJS_output(model_output[prompt_id])
        parsed_list_dict[prompt_id] = letter_to_number(parsed_output)
