...
def calculate_per_category_result_RLD(dataset, parsed_output_path, b2c):
    random.seed(123)
    np.random.seed(123)
    ...
    for cat in category_model_output:
        ...
        w_acc_mean, w_acc_ste = bootstrap_weighted_accuracy(curr_cat_model_output, curr_cat_gt_answer, n_iterations=1000)
        
        result[cat]['weighted_accuracy_mean'] = w_acc_mean
        result[cat]['weighted_accuracy_ste'] = w_acc_ste
    ...
    w_acc_mean, w_acc_std = bootstrap_weighted_accuracy(full_model_output, full_correct_output)
    ...
    result['full']['weighted_accuracy_mean'] = w_acc_mean
    result['full']['weighted_accuracy_ste'] = w_acc_std
...
if __name__ == "__main__":
    ...
    ret = calculate_per_category_result_RLD(dataset, input_path, b2c)
