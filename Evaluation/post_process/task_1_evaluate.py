...
if __name__ == "__main__":
    ...
    for idx, key in enumerate(dataset):
        ...
        if parsed_list_dict[key] is None:
            model_output.append(int(str(dataset[key]['answer'] == "included").lower() != "true"))
            correct_output.append(int(str(dataset[key]['answer'] == "included").lower() == "true"))
            continue
        ...
        answer = int(dataset[key]['answer'] == "included")
