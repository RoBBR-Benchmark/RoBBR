...
pid_file="logs/PIDs/PIDs_from_task_3_SJS_eval_${exp_name}_${current_time}.pids"
...
python3 pre_process/create_task_3_prompt.py --dataset "$dataset_path" --prompt_template_name "$prompt_template_name" --prompt_dict_name "$exp_name"

echo "Finish TASK 3 prompt dict generation..."
echo "=================================================================="
...
# Parsing
python3 post_process/task_3_parsing.py --model_name ${model_name} --model_output_path "generation/outputs/${exp_name}/collected_results.pickle" --parsed_output_path "./post_process/parsed_output/${exp_name}.pickle" --dataset_path ${dataset_path}
...
python3 post_process/task_3_evaluate.py --model_name ${model_name} --input_path "./post_process/parsed_output/${exp_name}.pickle" --dataset_path ${dataset_path} --exp_name ${exp_name} --logging_csv "post_process/logs.csv"
